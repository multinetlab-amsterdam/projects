...
Change variables so a high score equals more symptoms. 
```{r}
df$mos_cog <- 42-df$mos_cog
df$SF36_PF <- 100-df$SF36_PF
df$SF36_SC <- 100-df$SF36_SC
df$SF36_RLP <- 100-df$SF36_RLP
df$SF36_RLM <- 100-df$SF36_RLM
df$SF36_MH <- 100-df$SF36_MH
df$SF36_P <- 100-df$SF36_P
df$SF36_HP <- 100-df$SF36_HP
df$SF36_CIH <- 100-df$SF36_CIH
```
...
labels_12 <- c("CIS-F", "CIS-C", "CIS-M", "CIS-A", 
               "MOS-Cog", 
               "CES-D", 
               "SF-PhF","SF-ScF","SF-RLP","SF-RLM", "SF-MH","SF-BP","SF-HP","SF-CiH",
