...
# df_SF36_controls_selection = controls
# df_SF36_diagnosis_selection = patients at time of diagnosis
...
# Dataframe with only controls; in 1 column (each patient gematched with 2 controls)
...
# Glioma patients will be matched with controls from the general population based on age, sex and educational level
# df_SF36_controls_selection = controls
# df_SF36_stable_selection = patients during stable disease
...
##### 2.1 SF36 PF data: glioma patients at time of diagnosis vs stable disease
# selected_pairs = patients with data at both time points; longitudinal data 
...
##### 2.2 CIS20 data: glioma patients at time of diagnosis vs stable disease
# CIS_fitness_reversed = patiets with data at both time points (CIS20); and higher scores, means better fitness
...
# T-test 
result_ttest <- wilcox.test(selected_pairs$CIS_fitness_reversed[selected_pairs$Time_moment == 1], selected_pairs$CIS_fitness_reversed[selected_pairs$Time_moment == 2], paired = TRUE)
```

## Create results 
```{r}
# Test statistic W and number of pairs n
W <- result_ttest$statistic
n <- sum(selected_pairs$Time_moment == 1)
