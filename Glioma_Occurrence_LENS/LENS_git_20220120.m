...
%%date__ = 2022/01/20 % date script was created
...
load('/data/KNW/l.douw/numan_lens/git_data/LENS_source_data_final.mat')
...
tcga_data_cortical = tcga_data(1:210,:);
tcga_data_cortical_per = tcga_data/102*100; % calculate percentage

[corr_slope_tcga, p_slope_tcga] = corr(tcga_data_cortical(1:210), HC_FOOOF_slope_matched_to_AMS_mean', 'type', 'spearman');
[corr_offset_tcga, p_offset_tcga] = corr(tcga_data_cortical(1:210), HC_FOOOF_offset_matched_to_AMS_mean', 'type', 'spearman');
[corr_bbp_tcga, p_bbp_tcga] = corr(tcga_data_cortical(1:210), HC_broadband_power_matched_to_AMS_mean', 'type', 'spearman');

%% reproduce with old HCs

[corr_slope_tcga_old, p_slope_tcga_old] = corr(tcga_data_cortical(1:210), (mean(HC_FOOOF_slope_old,1))', 'type', 'spearman');
[corr_offset_tcga_old, p_offset_tcga_old] = corr(tcga_data_cortical(1:210), (mean(HC_FOOOF_offset_old,1))', 'type', 'spearman');
[corr_bbp_tcga_old, p_bbp_tcga_old] = corr(tcga_data_cortical(1:210), (mean(HC_broadband_power_old,1))', 'type', 'spearman');

%% Correlations without high medial brain regions (potentially due to low SNR), primary analyses

HC_bbp_q3 = quantile(HC_broadband_power_matched_to_AMS_mean,0.75);
HC_broadband_power_matched_mean_AMS_low = HC_broadband_power_matched_to_AMS_mean;
HC_broadband_power_matched_mean_AMS_low(HC_broadband_power_matched_to_AMS_mean > HC_bbp_q3) = NaN;
...
HC_FOOOF_slope_matched_mean_AMS_low = HC_FOOOF_slope_matched_to_AMS_mean;
HC_FOOOF_slope_matched_mean_AMS_low(HC_FOOOF_slope_matched_to_AMS_mean > HC_slope_q3) = NaN;
...
HC_FOOOF_offset_matched_mean_AMS_low = HC_FOOOF_offset_matched_to_AMS_mean;
HC_FOOOF_offset_matched_mean_AMS_low(HC_FOOOF_offset_matched_to_AMS_mean > HC_offset_q3) = NaN;
...
% full cohorts
[corr_slope_ams_q3, p_slope_ams_q3] = corr(tumor_occ_AMS_perc(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_ams_q3, p_offset_ams_q3] = corr(tumor_occ_AMS_perc(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_ams_q3, p_bbp_ams_q3] = corr(tumor_occ_AMS_perc(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

[corr_slope_boston_q3, p_slope_boston_q3] = corr(boston_data_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_boston_q3, p_offset_boston_q3] = corr(boston_data_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_boston_q3, p_bbp_boston_q3] = corr(boston_data_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

[corr_slope_tcga_q3, p_slope_tcga_q3] = corr(tcga_data_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_tcga_q3, p_offset_tcga_q3] = corr(tcga_data_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_tcga_q3, p_bbp_tcga_q3] = corr(tcga_data_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

% subgroup 1
[corr_slope_ams_idhmut_codel_q3, p_slope_ams_idhmut_codel_q3] = corr(ams_data_idhmut_codel_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_ams_idhmut_codel_q3, p_offset_ams_idhmut_codel_q3] = corr(ams_data_idhmut_codel_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_ams_idhmut_codel_q3, p_bbp_ams_idhmut_codel_q3] = corr(ams_data_idhmut_codel_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

% subgroup 2
[corr_slope_ams_idhmut_noncodel_q3, p_slope_ams_idhmut_noncodel_q3] = corr(ams_data_idhmut_noncodel_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_ams_idhmut_noncodel_q3, p_offset_ams_idhmut_noncodel_q3] = corr(ams_data_idhmut_noncodel_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_ams_idhmut_noncodel_q3, p_bbp_ams_idhmut_noncodel_q3] = corr(ams_data_idhmut_noncodel_cortical(select_low_regions_bbp),(HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

[corr_slope_boston_idhmut_noncodel_q3, p_slope_boston_idhmut_noncodel_q3] = corr(boston_data_idhmut_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_boston_idhmut_noncodel_q3, p_offset_boston_idhmut_noncodel_q3] = corr(boston_data_idhmut_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_boston_idhmut_noncodel_q3, p_bbp_boston_idhmut_noncodel_q3] = corr(boston_data_idhmut_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

% subgroup 3
[corr_slope_ams_idhwt_q3, p_slope_ams_idhwt_q3] = corr(ams_data_idhwt_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_ams_idhwt_q3, p_offset_ams_idhwt_q3] = corr(ams_data_idhwt_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_ams_idhwt_q3, p_bbp_ams_idhwt_q3] = corr(ams_data_idhwt_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');

[corr_slope_boston_idhwt_q3, p_slope_boston_idhwt_q3] = corr(boston_data_idhwt_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_offset_boston_idhwt_q3, p_offset_boston_idhwt_q3] = corr(boston_data_idhwt_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_bbp_boston_idhwt_q3, p_bbp_boston_idhwt_q3] = corr(boston_data_idhwt_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');


%% Investigate correlations between brain activity measures

exclude_high_regions_all = unique(cat(1,find(isnan(HC_broadband_power_matched_mean_AMS_low)),find(isnan(HC_FOOOF_offset_matched_mean_AMS_low)),find(isnan(HC_FOOOF_slope_matched_mean_AMS_low))));
...
all_idhwt_cortical = sum(cat(2,boston_data_idhwt_cortical,ams_data_idhwt_cortical,tcga_data_cortical),2);
all_idhmut_noncodel_cortical = sum(cat(2,ams_data_idhmut_noncodel_cortical,boston_data_idhmut_cortical),2);
all_idhmut_codel_cortical = sum(cat(2,ams_data_idhmut_codel_cortical),2);

[corr_slope_all_idhwt_q3, p_slope_all_idhwt_q3] = corr(all_idhwt_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_slope_all_idhmut_noncodel_q3, p_slope_all_idhmut_noncodel_q3] = corr(all_idhmut_noncodel_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');
[corr_slope_all_idhmut_codel_q3, p_slope_all_idhmut_codel_q3] = corr(all_idhmut_codel_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))', 'type', 'spearman');

[corr_offset_all_idhwt_q3, p_offset_all_idhwt_q3] = corr(all_idhwt_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_offset_all_idhmut_noncodel_q3, p_offset_all_idhmut_noncodel_q3] = corr(all_idhmut_noncodel_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');
[corr_offset_all_idhmut_codel_q3, p_offset_all_idhmut_codel_q3] = corr(all_idhmut_codel_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))', 'type', 'spearman');

[corr_bbp_all_idhwt_q3, p_bbp_all_idhwt_q3] = corr(all_idhwt_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');
[corr_bbp_all_idhmut_noncodel_q3, p_bbp_all_idhmut_noncodel_q3] = corr(all_idhmut_noncodel_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');
[corr_bbp_all_idhmut_codel_q3, p_bbp_all_idhmut_codel_q3] = corr(all_idhmut_codel_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))', 'type', 'spearman');
...
figure()
subplot(1,3,1)
scatter(all_idhmut_codel_cortical, HC_broadband_power_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhmut_codel_cortical,HC_broadband_power_matched_to_AMS_mean,xneg_bbp,xneg_bbp,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

subplot(1,3,2)
scatter(all_idhmut_codel_cortical, HC_FOOOF_offset_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhmut_codel_cortical, HC_FOOOF_offset_matched_to_AMS_mean,xneg_offset,xneg_offset,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

subplot(1,3,3)
scatter(all_idhmut_codel_cortical, HC_FOOOF_slope_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhmut_codel_cortical, HC_FOOOF_slope_matched_to_AMS_mean,xneg_slope,xneg_slope,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

%% Create Figure 2B

subplot(1,3,1)
scatter(all_idhmut_noncodel_cortical, HC_broadband_power_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhmut_noncodel_cortical,HC_broadband_power_matched_to_AMS_mean,xneg_bbp,xneg_bbp,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

subplot(1,3,2)
scatter(all_idhmut_noncodel_cortical, HC_FOOOF_offset_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhmut_noncodel_cortical, HC_FOOOF_offset_matched_to_AMS_mean,xneg_offset,xneg_offset,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

subplot(1,3,3)
scatter(all_idhmut_noncodel_cortical, HC_FOOOF_slope_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhmut_noncodel_cortical, HC_FOOOF_slope_matched_to_AMS_mean,xneg_slope,xneg_slope,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

%% Create Figure 2C

subplot(1,3,1)
scatter(all_idhwt_cortical, HC_broadband_power_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhwt_cortical,HC_broadband_power_matched_to_AMS_mean,xneg_bbp,xneg_bbp,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

subplot(1,3,2)
scatter(all_idhwt_cortical, HC_FOOOF_offset_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhwt_cortical, HC_FOOOF_offset_matched_to_AMS_mean,xneg_offset,xneg_offset,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)

subplot(1,3,3)
scatter(all_idhwt_cortical, HC_FOOOF_slope_matched_to_AMS_mean,'filled','k') 
hold all
errorbar(all_idhwt_cortical, HC_FOOOF_slope_matched_to_AMS_mean,xneg_slope,xneg_slope,yneg,yneg,'o','Color','#808080')
set(gca,'FontSize',20)
...
%% Create datasets to run spintest on (significant results only)

% AMS noncodel offset
% BOS noncodel offset
% combined noncodel offset
% AMS wt offset
% BOS wt bbp, offset, slope
% TCGA bbp, offset, slope
% combined wt bbp, offset, slope

slope_all_idhwt_q3 = cat(2,all_idhwt_cortical(select_low_regions_slope),(HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))');
offset_all_idhwt_q3 = cat(2,all_idhwt_cortical(select_low_regions_offset),(HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
offset_all_idhmut_noncodel_q3 = cat(2,all_idhmut_noncodel_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
bbp_all_idhwt_q3 = cat(2,all_idhwt_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))');
offset_ams_idhmut_noncodel_q3 = cat(2,ams_data_idhmut_noncodel_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
offset_boston_idhmut_noncodel_q3 = cat(2,boston_data_idhmut_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
offset_ams_idhwt_q3 = cat(2,ams_data_idhwt_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
slope_boston_idhwt_q3 = cat(2,boston_data_idhwt_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))');
offset_boston_idhwt_q3 = cat(2,boston_data_idhwt_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
bbp_boston_idhwt_q3 = cat(2,boston_data_idhwt_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))');
slope_tcga_q3 = cat(2,tcga_data_cortical(select_low_regions_slope), (HC_FOOOF_slope_matched_mean_AMS_low(select_low_regions_slope))');
offset_tcga_q3 = cat(2,tcga_data_cortical(select_low_regions_offset), (HC_FOOOF_offset_matched_mean_AMS_low(select_low_regions_offset))');
bbp_tcga_q3 = cat(2,tcga_data_cortical(select_low_regions_bbp), (HC_broadband_power_matched_mean_AMS_low(select_low_regions_bbp))');
