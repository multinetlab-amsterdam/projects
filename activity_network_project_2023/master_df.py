...
standardize_activity_metrics(
    input_dir_bbos, input_HC_dir_bbos, output_dir, HC_subs_li, HC=False
)  # standardize patients metrics
standardize_activity_metrics(
    input_HC_dir_bbos, input_HC_dir_bbos, output_dir, HC_subs_li, HC=True
...
def concat_power_network(df_BB_welch, dict_net_df, HC=False):
    ...
    df_activity = df_BB_welch[
        ["BB_welch_z", "offset_z", "slope_z", "sub", "roi"]
    ].sort_values(["sub", "roi"])
...
dict_dfs = {
    "_theta_01": df_theta_01,
    "_theta_02": df_theta_02,
    "_theta_03": df_theta_03,
    "_delta_01": df_delta_01,
    "_delta_02": df_delta_02,
    "_delta_03": df_delta_03,
    "_alpha_01": df_alpha_01,
    "_alpha_02": df_alpha_02,
    "_alpha_03": df_alpha_03,
}


dict_dfs_HC = {
    "_theta_01": df_theta_01_HC,
    "_theta_02": df_theta_02_HC,
    "_theta_03": df_theta_03_HC,
    "_delta_01": df_delta_01_HC,
    "_delta_02": df_delta_02_HC,
    "_delta_03": df_delta_03_HC,
    "_alpha_01": df_alpha_01_HC,
    "_alpha_02": df_alpha_02_HC,
    "_alpha_03": df_alpha_03_HC,
}
